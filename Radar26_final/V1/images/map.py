...
# 方法1: 创建纯黑色图片
def create_black_image(width=1500, height=1500):
    """创建指定尺寸的纯黑色图片"""
    # 创建全0的数组，对应黑色
...
# 方法2: 使用指定颜色创建
def create_color_image(width=1500, height=1500, color=(0, 0, 0)):
    """创建指定颜色和尺寸的图片"""
    # 创建一个全为指定颜色的图片
...
if __name__ == "__main__":
    ...
    # 简单创建黑色图片
    black_img = create_black_image(350, 350)
